...
const FinancingSection = ({
  ...
  return (
    <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
      ...
      <RadioGroup
        value={financingType}
        onValueChange={(value: "cash" | "financing" | "lease") =>
      ...
      {(financingType === "financing" || financingType === "lease") && (
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Select
              onValueChange={(value) =>
                setFinancingDetails((prev) => ({ ...prev, term: value }))
              }
            >
              <SelectTrigger>
                <SelectValue
                  placeholder={t("form.financing.termPlaceholder")}
                />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="24">
                  24 {t("form.financing.months")}
                </SelectItem>
                <SelectItem value="36">
                  36 {t("form.financing.months")}
                </SelectItem>
                <SelectItem value="48">
                  48 {t("form.financing.months")}
                </SelectItem>
                <SelectItem value="60">
                  60 {t("form.financing.months")}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
              ...
              <Select
                onValueChange={(value) =>
                  setFinancingDetails((prev) => ({
                    ...prev,
                    annualKilometers: value,
                  }))
                }
              >
                <SelectTrigger>
                  <SelectValue
                    placeholder={t("form.financing.kmPlaceholder")}
                  />
                </SelectTrigger>
                <SelectContent>
