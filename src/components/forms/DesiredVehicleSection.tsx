    ...
    <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Select
            onValueChange={(value) =>
              setDesiredVehicle((prev) => ({ ...prev, year: value, model: "" }))
            }
        ...
        <div className="space-y-2">
          ...
          <Select
            onValueChange={(value) =>
              setDesiredVehicle((prev) => ({ ...prev, make: value, model: "" }))
            }
        ...
        <div className="space-y-2">
          ...
          <Select
            onValueChange={(value) =>
              setDesiredVehicle((prev) => ({ ...prev, model: value }))
            }
        ...
        {carDetails && !isLoadingDetails && (
          <Card className="col-span-2 p-4 space-y-3">
            <h5 className="font-medium">
              {t("form.carDetails.specifications")}
            </h5>
            <div className="space-y-2 text-sm text-muted-foreground">
              ...
              <p>
                <strong>Fuel Efficiency:</strong> {carDetails.fuelEfficiency}
              </p>
              <p>
                <strong>Safety Features:</strong> {carDetails.safetyFeatures}
              </p>
              <p>
                <strong>Technology:</strong> {carDetails.technology}
              </p>
              <p>
                <strong>Available Trims:</strong> {carDetails.trims}
              </p>
              <p>
                <strong>Price Range:</strong> {carDetails.priceRange}
              </p>
            </div>
          </Card>
        )}
