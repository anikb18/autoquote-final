            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditingPlan((prev) =>
                      prev ? { ...prev, name: e.target.value } : defaultPlan,
                    )
                  }
                />
              </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setEditingPlan((prev) =>
                        prev
                          ? { ...prev, monthlyPrice: Number(e.target.value) }
                          : defaultPlan,
                      )
                    }
                  />
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setEditingPlan((prev) =>
                        prev
                          ? { ...prev, annualPrice: Number(e.target.value) }
                          : defaultPlan,
                      )
                    }
                  />
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setEditingPlan((prev) =>
                      prev ? { ...prev, isFeatured: checked } : defaultPlan,
                    )
                  }
                />
              ...
              <Button
                onClick={() => editingPlan && handleSavePlan(editingPlan)}
              >
                {t("pricing.save")}
              </Button>
            </div>
