...
const EMAIL_TEMPLATES = [
  {
    ...
    fields: [
      ...
      { name: "yearModel", label: "Year", placeholder: "e.g., 2024" },
      {
        name: "keyFeatures",
        label: "Key Features",
        placeholder: "e.g., Hybrid engine, panoramic roof",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder: "e.g., Must be 2018 or newer",
      },
    ],
  },
  {
    ...
    fields: [
      {
        name: "serviceType",
        label: "Service Type",
        placeholder: "e.g., Winter Maintenance Package",
      },
      {
        name: "discount",
      ...
      },
      {
        name: "validPeriod",
        label: "Valid Period",
        placeholder: "e.g., January 15-31, 2024",
      },
    ],
  },
];
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Choose a template or enter your own topic to generate professional
            email content
          </DialogDescription>
        </DialogHeader>
